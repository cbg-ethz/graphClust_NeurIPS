...
#' @importFrom grDevices rgb
#'
bestAICsearch_test <- function(binaryMatrix, minK = 2, maxK=5, chiVec=c(1e-3,0.5,1,2,3), startseed = 100, nIterations = 50, AICrange=100) {
  #
  #     require('ggplot2')
  #     require('reshape2')
...
#' @importFrom grDevices rgb
#'
bestAICsearch_plain <- function(binaryMatrix, minK = 2, maxK=5, chiVec=c(1e-3,0.5,1,2,3), startseed = 100, nIterations = 50) {
  #
  #     require('ggplot2')
  #     require('reshape2')
  ...
  # dev.off()
  return(list(output=output, aics=plain_aics))
}
